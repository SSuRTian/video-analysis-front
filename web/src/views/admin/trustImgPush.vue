<template>
    <!--此界面用于上传信任人员照片，使其可以通过保密区域而不触发入侵警报-->
    <!--此页面应当归属于管理员界面，信任人员管理，但是具体逻辑还没确定，只是先做个页面-->
        ...
        <el-container  style="height: 700px; border: 1px solid #eee"> <!--头部标题栏-->
            ...
            <el-container>
                <el-aside width="230px" style="border: 1px solid #eee"> <!--侧边栏-->
                    <!--这里侧边栏内容有问题，因为本上传照片页面隶属于管理员界面下的信任人员管理，所以侧边栏不应该是
                ...
                <el-main>  <!--上传信任人员照片的主体页面-->
                    <el-upload
                        ...
                        <div slot="tip" class="el-upload__tip">请上传至少3张信任人员照片（jpg/png/imag/jpeg文件,且不超过10MB）</div>
                    </el-upload>
                </el-main>
            </el-container>
        </el-container>
