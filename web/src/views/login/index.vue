<template>
    <div>
        <el-form :rules="rules" ref="loginForm" :model="loginForm" class="loginContainer">
            ...
            <el-form-item prop="username" :style="{ paddingLeft: '10px', paddingRight: '10px' }">
            ...
            <el-form-item prop="code" :style="{ paddingLeft: '10px', paddingRight: '10px' }">
            ...
            <router-link to='/register'>
                <el-button type="text" style="width:5%;margin-bottom:5px;margin-top: -40px;"
                    @click="$router.push('/sign')">sign in</el-button>
            </router-link>  
        </el-form>
    </div>
</template>
